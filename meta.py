...
def _make_functional(module, params_box, params_offset):
    ...
    if hasattr(module, "_user_forward"):
        setattr(self, "_user_forward", module._user_forward)
    if hasattr(module, "_wide_forward"):
        setattr(self, "_wide_forward", module._wide_forward)
    if hasattr(module, "_deep_forward"):
        setattr(self, "_deep_forward", module._wide_forward)
